...
def header_footer(canvas, doc,title):
    ...
    canvas.drawInlineImage("./assets/ISARIC_logo.png", 50, 730, width=69, height=30)  
    ...
    #canvas.drawInlineImage("./assets/who_logo.png", 130, 730, width=98, height=30)  #modify for deploy
